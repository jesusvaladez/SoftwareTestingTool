...
public class ClusterInstallWithoutStartTest extends org.easymock.EasyMockSupport {
    ...
    public void setup() throws java.lang.Exception {
        ...
        EasyMock.expect(blueprint.getName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.BLUEPRINT_NAME).anyTimes();
        ...
        EasyMock.expect(stack.getName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.STACK_NAME).anyTimes();
        EasyMock.expect(stack.getVersion()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.STACK_VERSION).anyTimes();
        ...
        EasyMock.expect(request.getClusterId()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_ID).anyTimes();
        EasyMock.expect(request.getClusterName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_NAME).anyTimes();
        ...
        EasyMock.expect(request.getProvisionAction()).andReturn(org.apache.ambari.server.controller.internal.ProvisionAction.INSTALL_ONLY).anyTimes();
        ...
        EasyMock.expect(group1.getBlueprintName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.BLUEPRINT_NAME).anyTimes();
        ...
        EasyMock.expect(group2.getBlueprintName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.BLUEPRINT_NAME).anyTimes();
        ...
        EasyMock.expect(clusters.getCluster(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_NAME)).andReturn(cluster).anyTimes();
        EasyMock.expect(cluster.getClusterName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_NAME).anyTimes();
        EasyMock.expect(ambariContext.getPersistedTopologyState()).andReturn(persistedState).anyTimes();
        ambariContext.createAmbariResources(EasyMock.isA(org.apache.ambari.server.topology.ClusterTopology.class), EasyMock.eq(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_NAME), ((org.apache.ambari.server.state.SecurityType) (EasyMock.isNull())), EasyMock.eq("1"), EasyMock.anyLong());
        EasyMock.expectLastCall().once();
        EasyMock.expect(ambariContext.getNextRequestId()).andReturn(1L).once();
        EasyMock.expect(ambariContext.isClusterKerberosEnabled(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_ID)).andReturn(false).anyTimes();
        EasyMock.expect(ambariContext.getClusterId(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_NAME)).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_ID).anyTimes();
        EasyMock.expect(ambariContext.getClusterName(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_ID)).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_NAME).anyTimes();
        ...
        EasyMock.expect(ambariContext.createAmbariTask(EasyMock.anyLong(), EasyMock.anyLong(), EasyMock.anyString(), EasyMock.anyString(), EasyMock.eq(org.apache.ambari.server.topology.AmbariContext.TaskType.INSTALL), EasyMock.anyBoolean())).andReturn(hostRoleCommand).atLeastOnce();
