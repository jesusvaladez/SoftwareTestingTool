...
public class ClusterInstallWithoutStartOnComponentLevelTest extends org.easymock.EasyMockSupport {
    ...
    public void setup() throws java.lang.Exception {
        ...
        EasyMock.expect(blueprint.getName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartOnComponentLevelTest.BLUEPRINT_NAME).anyTimes();
        ...
        EasyMock.expect(stack.getName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartOnComponentLevelTest.STACK_NAME).anyTimes();
        EasyMock.expect(stack.getVersion()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartOnComponentLevelTest.STACK_VERSION).anyTimes();
        ...
        EasyMock.expect(request.getClusterId()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartOnComponentLevelTest.CLUSTER_ID).anyTimes();
        EasyMock.expect(request.getClusterName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartOnComponentLevelTest.CLUSTER_NAME).anyTimes();
        ...
        EasyMock.expect(request.getProvisionAction()).andReturn(org.apache.ambari.server.controller.internal.ProvisionAction.INSTALL_AND_START).anyTimes();
        ...
        EasyMock.expect(group1.getBlueprintName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartOnComponentLevelTest.BLUEPRINT_NAME).anyTimes();
        ...
        EasyMock.expect(group1.getComponentNames(org.apache.ambari.server.controller.internal.ProvisionAction.INSTALL_ONLY)).andReturn(java.util.Arrays.asList("component1")).anyTimes();
        EasyMock.expect(group1.getComponentNames(org.apache.ambari.server.controller.internal.ProvisionAction.START_ONLY)).andReturn(java.util.Collections.emptyList()).anyTimes();
        ...
        EasyMock.expect(group2.getBlueprintName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartOnComponentLevelTest.BLUEPRINT_NAME).anyTimes();
        ...
        EasyMock.expect(group2.getComponentNames(org.apache.ambari.server.controller.internal.ProvisionAction.INSTALL_ONLY)).andReturn(java.util.Collections.emptyList()).anyTimes();
        EasyMock.expect(group2.getComponentNames(org.apache.ambari.server.controller.internal.ProvisionAction.START_ONLY)).andReturn(java.util.Collections.emptyList()).anyTimes();
        ...
        EasyMock.expect(clusters.getCluster(org.apache.ambari.server.topology.ClusterInstallWithoutStartOnComponentLevelTest.CLUSTER_NAME)).andReturn(cluster).anyTimes();
        EasyMock.expect(cluster.getClusterName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartOnComponentLevelTest.CLUSTER_NAME).anyTimes();
        EasyMock.expect(ambariContext.getPersistedTopologyState()).andReturn(persistedState).anyTimes();
        ambariContext.createAmbariResources(EasyMock.isA(org.apache.ambari.server.topology.ClusterTopology.class), EasyMock.eq(org.apache.ambari.server.topology.ClusterInstallWithoutStartOnComponentLevelTest.CLUSTER_NAME), ((org.apache.ambari.server.state.SecurityType) (EasyMock.isNull())), ((java.lang.String) (EasyMock.eq("1"))), EasyMock.anyLong());
        EasyMock.expectLastCall().once();
        EasyMock.expect(ambariContext.getNextRequestId()).andReturn(1L).once();
        EasyMock.expect(ambariContext.isClusterKerberosEnabled(org.apache.ambari.server.topology.ClusterInstallWithoutStartOnComponentLevelTest.CLUSTER_ID)).andReturn(false).anyTimes();
        EasyMock.expect(ambariContext.getClusterId(org.apache.ambari.server.topology.ClusterInstallWithoutStartOnComponentLevelTest.CLUSTER_NAME)).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartOnComponentLevelTest.CLUSTER_ID).anyTimes();
        EasyMock.expect(ambariContext.getClusterName(org.apache.ambari.server.topology.ClusterInstallWithoutStartOnComponentLevelTest.CLUSTER_ID)).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartOnComponentLevelTest.CLUSTER_NAME).anyTimes();
        ...
        EasyMock.expect(ambariContext.createAmbariTask(EasyMock.anyLong(), EasyMock.anyLong(), EasyMock.anyString(), EasyMock.anyString(), EasyMock.eq(org.apache.ambari.server.topology.AmbariContext.TaskType.INSTALL), EasyMock.anyBoolean())).andReturn(hostRoleCommand).times(7);
        EasyMock.expect(ambariContext.createAmbariTask(EasyMock.anyLong(), EasyMock.anyLong(), EasyMock.anyString(), EasyMock.anyString(), EasyMock.eq(org.apache.ambari.server.topology.AmbariContext.TaskType.START), EasyMock.anyBoolean())).andReturn(hostRoleCommand).times(1);
        EasyMock.expect(hostRoleCommand.getTaskId()).andReturn(1L).atLeastOnce();
        EasyMock.expect(hostRoleCommand.getRoleCommand()).andReturn(org.apache.ambari.server.RoleCommand.INSTALL).atLeastOnce();
        EasyMock.expect(hostRoleCommand.getRole()).andReturn(org.apache.ambari.server.Role.INSTALL_PACKAGES).atLeastOnce();
        EasyMock.expect(hostRoleCommand.getStatus()).andReturn(org.apache.ambari.server.actionmanager.HostRoleStatus.COMPLETED).atLeastOnce();
