...
public class ServiceFormattedException extends javax.ws.rs.WebApplicationException {
    ...
    protected static javax.ws.rs.core.Response errorEntity(java.lang.String message, java.lang.Throwable e) {
        ...
        return javax.ws.rs.core.Response.status(org.apache.ambari.view.capacityscheduler.utils.ServiceFormattedException.STATUS).entity(new org.json.simple.JSONObject(response)).type(MediaType.APPLICATION_JSON).build();
    }
}